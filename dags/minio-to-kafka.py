...
# Local File Path
LOCAL_TEMP_PATH = os.getenv("LOCAL_TEMP_PATH", "/tmp/skincare_raw.json")
...
def load_raw_to_snowflake(**context):
    ...
    for event in events:
        cur.execute(insert_sql, (
            ...
            event.get("shipping_cost"),
            event.get("voucher_code"),
...
with DAG(
    "skincare_minio_to_snowflake_bronze",
    default_args=default_args,
    description="Load raw skincare events from MinIO to Snowflake Bronze table",
